...
export RESPONSE_OPERATIONS_SAMPLE_SERVICE_HOST="samplesvc-dev.apps.devtest.onsclofo.uk"
...
export RESPONSE_OPERATIONS_SURVEY_SERVICE_HOST="surveysvc-dev.apps.devtest.onsclofo.uk"

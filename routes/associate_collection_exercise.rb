get '/associate_collection_exercise' do
  ...
  puts 'collectionexercises: ' + collectionexercises.to_s
...
post '/associate_collection_exercise' do
    ...
    puts 'collectionexercise: ' + collectionexercise.to_s
    puts "#{settings.protocol}://#{settings.collection_exercise_service_host}:#{settings.collection_exercise_service_port}/collectionexercises/#{collectionexercise}"
